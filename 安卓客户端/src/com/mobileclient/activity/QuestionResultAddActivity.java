...
public class QuestionResultAddActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.questionresult_add); 
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("添加问卷结果");
			...
			public void onClick(View v) {
				try {
					...
					if(ET_answer.getText().toString().equals("")) {
						Toast.makeText(QuestionResultAddActivity.this, "问卷回答输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传问卷结果信息*/
					QuestionResultAddActivity.this.setTitle("正在上传问卷结果信息，稍等...");
					String result = questionResultService.AddQuestionResult(questionResult);

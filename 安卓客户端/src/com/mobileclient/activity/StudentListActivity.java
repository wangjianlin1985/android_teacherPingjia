				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new StudentSimpleAdapter(StudentListActivity.this, list,
	        					...
	        					new String[] { "studentNumber","password","name","sex","age","telephone","qq" },
	        					new int[] { R.id.tv_studentNumber,R.id.tv_password,R.id.tv_name,R.id.tv_sex,R.id.tv_age,R.id.tv_telephone,R.id.tv_qq,},lv);

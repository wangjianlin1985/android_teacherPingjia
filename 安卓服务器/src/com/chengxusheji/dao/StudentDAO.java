...
public class StudentDAO {
    ...
    public ArrayList<Student> QueryStudentInfo(String studentNumber,String name,String sex,String telephone,String qq,int currentPage) { 
    	Session s = factory.getCurrentSession();
    	...
    	if(!sex.equals("")) hql = hql + " and student.sex like '%" + sex + "%'";
    	if(!telephone.equals("")) hql = hql + " and student.telephone like '%" + telephone + "%'";
    	if(!qq.equals("")) hql = hql + " and student.qq like '%" + qq + "%'";
    ...
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public ArrayList<Student> QueryStudentInfo(String studentNumber,String name,String sex,String telephone,String qq) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From Student student where 1=1";
    	if(!studentNumber.equals("")) hql = hql + " and student.studentNumber like '%" + studentNumber + "%'";
    	if(!name.equals("")) hql = hql + " and student.name like '%" + name + "%'";
    ...
    /*计算总的页数和记录数*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public void CalculateTotalPageAndRecordNumber(String studentNumber,String name,String sex,String telephone,String qq) {
        Session s = factory.getCurrentSession();
        String hql = "From Student student where 1=1";
        if(!studentNumber.equals("")) hql = hql + " and student.studentNumber like '%" + studentNumber + "%'";
        if(!name.equals("")) hql = hql + " and student.name like '%" + name + "%'";

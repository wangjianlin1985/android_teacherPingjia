...
public class TeacherDAO {
    ...
    public ArrayList<Teacher> QueryTeacherInfo(String teacherNumber,String name,String sex,String courseName,String telephone,int currentPage) { 
    	Session s = factory.getCurrentSession();
    	...
    	if(!sex.equals("")) hql = hql + " and teacher.sex like '%" + sex + "%'";
    	if(!courseName.equals("")) hql = hql + " and teacher.courseName like '%" + courseName + "%'";
    ...
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public ArrayList<Teacher> QueryTeacherInfo(String teacherNumber,String name,String sex,String courseName,String telephone) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From Teacher teacher where 1=1";
    	if(!teacherNumber.equals("")) hql = hql + " and teacher.teacherNumber like '%" + teacherNumber + "%'";
    	if(!name.equals("")) hql = hql + " and teacher.name like '%" + name + "%'";
    ...
    /*计算总的页数和记录数*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public void CalculateTotalPageAndRecordNumber(String teacherNumber,String name,String sex,String courseName,String telephone) {
        Session s = factory.getCurrentSession();
        String hql = "From Teacher teacher where 1=1";
        if(!teacherNumber.equals("")) hql = hql + " and teacher.teacherNumber like '%" + teacherNumber + "%'";
        if(!name.equals("")) hql = hql + " and teacher.name like '%" + name + "%'";
